...
user_rate = input('Введите новый элемент рейтинга: ')
if not user_rate.isdigit():
    print('Неверный формат ввода')
    exit()
elif int(user_rate) < 0:
    print('Неверный формат ввода')
    exit()

rate_list.append(int(user_rate))
rate_list.sort()
rate_list.reverse()

print(f'Пользователь ввел число {user_rate}. Результат: ', end='')
print(*rate_list, sep=', ')